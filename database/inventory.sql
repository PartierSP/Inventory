...
--
-- Table structure for table `featlist`
--

DROP TABLE IF EXISTS `featlist`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `featlist` (
...
CREATE TABLE `features` (
  `featid` smallint unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `item` (
  ...
  `location` smallint unsigned DEFAULT NULL,
  `bin` smallint unsigned DEFAULT NULL,
  PRIMARY KEY (`itemid`)
...
CREATE TABLE `location` (
  `locid` smallint unsigned NOT NULL AUTO_INCREMENT,
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `specs` (
  `specid` smallint unsigned NOT NULL AUTO_INCREMENT,
  `spec` varchar(80) DEFAULT NULL,
  `featid` smallint unsigned DEFAULT NULL,
  PRIMARY KEY (`specid`)
...
-- Dump completed on 2022-05-09  4:00:51
